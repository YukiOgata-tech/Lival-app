...
import CounselorMessageBubble from './CounselorMessageBubble';
      ...
      ListFooterComponent={
        showLoading ? (
          <View className="px-3 items-start">
            <View className="max-w-[68%] px-3 py-2 my-1 rounded-2xl bg-counselor-50 border border-counselor-200">
              <LottieView
              ...
              />
              <Text className="text-[11px] mt-1 text-counselor-700">進路カウンセラー が作成中…</Text>
            </View>
          </View>
        ) : null
      }
